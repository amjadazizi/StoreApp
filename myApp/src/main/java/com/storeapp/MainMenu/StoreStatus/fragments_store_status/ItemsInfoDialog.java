...
public class ItemsInfoDialog extends Activity {
   ...
   // private static final String PAYMENT_METHOD_CREDIT_CARD ="creditcard";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Utils.showToastLong("TOTAL =" + totalToPayAmount + "RECE = " + receivedAmount);
    ...
    private void registerPaymentMethod(final double cash, final double creditCard){
       ...
       final ParseQuery<TodaysTurnover> todaysTurnoverParseQuery = TodaysTurnover.getQuery(Prefs.getBusinessCvr());
        todaysTurnoverParseQuery.whereEqualTo(TodaysTurnover.TODAYS_TURNOVER_DATE, Utils.getCurrentDate());
            ...
            public void done(List<TodaysTurnover> todaysTurnovers, ParseException e) {
                if (e == null) {
                    if (todaysTurnovers != null && todaysTurnovers.size() > 0) {
                        ...
                        todaysTurnover.setDate(Utils.getCurrentDate());
    ...
    private void endExpedition() {
       ...
       //         CartItemsManager cartItemsManager1 = DbManager.getDbManager().getCartItemsManager();
//                cartItemsManager1.clearCart();
