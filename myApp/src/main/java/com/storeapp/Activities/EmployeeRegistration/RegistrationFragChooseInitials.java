/*
package com.storeapp.NewDesign.Activities.EmployeeRegistration;
...
import com.storeapp.ActivitiesOld.BaseFragment;
import com.storeapp.ActivitiesOld.RegisterPrefs;
		...
		btnDone.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!Utils.isNullOrEmpty(choosenInitials)) {
                    ...
                    ParseObject testObject = new ParseObject("UserManager");
                    testObject.put("name", RegisterPrefs.getFirstName()+ " "+ RegisterPrefs.getLastName() );
                    testObject.put("initials", choosenInitials);
                    testObject.put("phoneNumb", RegisterPrefs.getPhoneNumber());
                    testObject.put("email", RegisterPrefs.getEmail());
                    testObject.put("password", RegisterPrefs.getPassword());
